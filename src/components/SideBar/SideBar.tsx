            ...
            <div className='flex flex-col gap-5 pt-4'>
                ...
                <div className="ps-2 md:ps-6 pe-2 pb-4 border-b border-borderColor">
                    <ul className='flex flex-col gap-2 text-paragraphTextColor'>
                        ...
                        <li className='group'>
                            <NavLink to="/userProfile" className={({ isActive }) => `${ isActive? "bg-mainColor text-white": "bg-white"} flex flex-row gap-2 items-center w-full p-2 rounded-lg font-bold text-lg group-hover:bg-mainColor group-hover:text-white cursor-pointer transition-colors ease-in-out duration-500`}>
