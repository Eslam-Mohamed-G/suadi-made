...
export default function CreateAccount() {
  return (
    <div className='flex flex-col items-center gap-5 bg-backGroundColor py-8 h-dvh'>
      <header className="bg-mainColor text-white w-full text-center py-8">
        <h1 className='text-4xl font-bold'>هل أنت عميل أم صاحب شركة</h1>
      </header>
      ...
      <div className="flex flex-col items-center mt-16 text-center">
        ...
        <div className="flex flex-row gap-5 mt-5">
          ...
          <div className="bg-white rounded-xl shadow flex flex-col items-center justify-center p-4">
            ...
            <Link to="/userSignUp" className='bg-[#B49C5C] text-white flex flex-row items-center justify-center gap-2 w-full rounded-lg py-1 mt-4 cursor-pointer'>
